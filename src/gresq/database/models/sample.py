...
class Sample(Base):
    ...
    #author = relationship("Author", cascade="all, delete-orphan",
    #                 passive_deletes=True, primaryjoin="sample.id==author.sample_id",
    ...
    raman_file = relationship("RamanFile", cascade="all, delete-orphan",
